...
class GarmanKlassStrategy(OptimizeStrategy):
    def __init__(self, df, t1=14, t2=25, trial=None):
        ...
        df['Y'] = (Indicator.GarmanKlassVolatility(df.Open, df.High, df.Low, df.Close, t1) - Indicator.GarmanKlassVolatility(df.Open, df.High, df.Low, df.Close, t2))
